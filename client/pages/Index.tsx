  ...
  const solutions = [
    {
      ...
      description:
        "Connect with trusted suppliers in your area with quality guarantees",
    },
    {
      icon: IndianRupee,
      title: "Transparent Pricing",
      description:
        "Fixed daily rates with bulk discounts and no hidden charges",
    },
    {
      icon: Truck,
  ...
  const testimonials = [
    {
      ...
      quote:
        "ChaiSource cut my ingredient costs by 30% and saves me 2 hours daily!",
      rating: 5,
    },
    {
      name: "Priya Sharma",
      ...
      quote:
        "Finally, I can focus on cooking instead of running around for supplies.",
      rating: 5,
    },
    {
      name: "Mohammed Ali",
      ...
      business: "Dosa Cart",
      quote:
        "The quality is consistent and delivery is always on time. Game changer!",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge
                  variant="secondary"
                  className="bg-saffron/20 text-masala border-saffron/30"
                >
                ...
                <p className="text-xl text-muted-foreground max-w-lg">
                  India's first platform connecting street food vendors with
                  reliable suppliers. Get quality ingredients at fair prices,
                  delivered fresh to your stall.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Every street food vendor faces the same challenges. Behind every
              delicious plate of chaat or dosa, there's a hidden struggle with
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {problems.map((problem, index) => (
              <Card
                key={index}
                className="border-2 border-chili/20 hover:border-chili/40 transition-colors"
              >
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Meet <span className="text-primary">ChaiSource</span> - Your
              Solution
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              A digital platform designed specifically for street food vendors.
              No more uncertainty, no more running around - just reliable
              supplies.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  ...
                  <span className="text-curry">Street Vendor</span>
                </h2>
                <p className="text-xl text-muted-foreground">
                  Simple tools that actually work for your business. No
                  complicated forms, no confusing interfaces - just what you
                  need to grow.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <feature.icon
                      className={`h-8 w-8 ${feature.color} mt-1 flex-shrink-0`}
                    />
                    <div>
              ...
              <Button
                size="lg"
                className="bg-gradient-to-r from-curry to-turmeric hover:from-curry/90 hover:to-turmeric/90"
                asChild
              >
                <Link to="/marketplace">
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4">
                {[
                  ...
                  <Card
                    key={i}
                    className="bg-white/80 backdrop-blur border border-curry/20"
                  >
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Real vendors, real results. See how ChaiSource is transforming
              businesses.
            </p>
          </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-4 w-4 text-saffron fill-current"
                      />
                    ))}
                  </div>
      ...
      <section className="py-24 bg-gradient-to-r from-masala to-cardamom text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Join thousands of vendors who've already revolutionized their
            sourcing. Start your free trial today - no credit card required.
          </p>
          ...
          <div className="mt-8 text-white/70">
            <p>
              🚀 Get started in under 5 minutes • 📞 24/7 support in Hindi &
              English
            </p>
          </div>
        </div>
